...
public class StrMethod {
    public static void main(String[] args) {
        ...
        //문자열을 만들고 str1은 새로운 문자열의 주소값을 가리키게됨.
        ...
        System.out.println(str2.indexOf("program"));//"program"의 시작 문자열인 p문자의 위치 값을 리턴
        System.out.println(str2.indexOf("z"));//내용이 없으면 -1을 리턴(중요)
        System.out.println(str2.substring(0,4));//substring(string,end-1) => (0~3)
