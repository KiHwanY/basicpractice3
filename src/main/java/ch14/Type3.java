...
public class Type3<T> {// 자료형이 미정인 상태<아무문자> => <> 제너릭 기호
    ...
    public Type3() {} //만약 생성자처리를 하고자 한다면 <T>를 빼고 처리한다.

    public Type3(T a) {//생성자 매개변수를 쓴다면 타입은 위에서 정한 T로 처리해야 한다.
        t=a;
    }

    public void setT(T t) {// 메소드도 생성자 매개변수 처리와 같다.
        this.t = t;
    }
...
//        t3.setT(100.5);
        ...
        // <>자료형을 주지 않고 일반적 방법으로 처리 시 실행은 됨.
        // 내부적으로 모두 Object로 처리하게 되어 메모리 낭비가 심해진다.
        Type3 t4 = new Type3();
        t4.setT(100.5);
